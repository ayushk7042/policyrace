...
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
//   const [selectedPartnerUrl, setSelectedPartnerUrl] = useState(null);
...
//       <h1 className="partners-title">🤝 Our Trusted Partners</h1>
//       <p className="partners-subtitle">
//         Collaborating with top insurers and financial institutions to bring you the best coverage options.
//       </p>
...
//             transition={{ delay: index * 0.1 }}
//             whileHover={{ scale: 1.05 }}
//             onClick={() => setSelectedPartnerUrl(partner.link || "/post/rbi")}
//           >
//             <div className="partner-image-wrapper">
//               <img
//                 src={partner.iconUrl || partner.image}
...
//       {/* Inline Render */}
//       {selectedPartnerUrl && (
//         <div className="partner-iframe">
//           <iframe src={selectedPartnerUrl} title="Partner Page" />
//           <button className="close-iframe" onClick={() => setSelectedPartnerUrl(null)}>✖ Close</button>
//         </div>
//       )}
      ...
      <div className="partners-grid">
        {filtered.map((partner, index) => (
          <motion.div
            ...
            transition={{ delay: index * 0.1 }}
            whileHover={{ scale: 1.05 }}
            onClick={() => handleClick(partner.slug || "rbi")}
